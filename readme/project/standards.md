...
| Test suite | `cargo test` | Rust toolchain and dependencies available | Passed; 324 unit tests, 13 runnable CLI flag integration tests with 2 ignored, and 8 config error integration tests passed. | 2026-07-14 |
