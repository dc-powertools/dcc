...
| Test suite | `cargo test` | Rust toolchain and dependencies available | Passed; 355 unit tests, 16 runnable CLI flag integration tests with 2 ignored, and 9 config error integration tests passed. | 2026-07-14 |
