...
changes. It complements `readme/project/brief.md`: the brief explains product intent,
...
- Does not apply to: The reusable framework under `readme/meta/`, except when explicitly
