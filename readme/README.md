...
| --- | --- | --- |
| 2026-08-13 | Baked the supervisor scripts into the image (T-0029), added a semver compatibility gate on `dcc.version` (T-0030), and removed vestigial build-prep hook assets (T-0031). | `readme/decisions/0004-embed-supervisor-in-image.md` |
