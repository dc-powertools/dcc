...
- [ ] Durable vs one-shot reuse, `--keep` promotion, and all three `dcc stop` variants
      behave as before.
- [ ] README and `readme/project/architecture.md` describe the revised startup sequence.
...
- Why this risk gate: An error breaks cold-start for all runtime commands, or silently
  ...
  tests alone.
- Upstream artifacts required: `readme/tasks/0024-supervisor-lifecycle-ownership-brief.md`,
