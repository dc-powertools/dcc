...
| T-0009 | Implement durable runtime lifecycle commands: `start`, `stop`, `run`, `exec`, `attach`, one-shot bookkeeping, and `--keep` promotion. | Parent T-0004 / r1 | Ready | T-0008 | Initiative / High | None | Create a T-0009 brief and delegate the implementation-heavy durable runtime lifecycle slice with disjoint ownership. | None | None |
