...
| T-0008 | Implement build preparation: official `build` source support, generated controller/hook assets, default prep hooks, and `build --refresh-only`. | Parent T-0004 / r1 | Ready | T-0005, T-0006, T-0007 | Initiative / High | None | Create a T-0008 brief and delegate the implementation-heavy build-preparation slice with disjoint ownership. | None | None |
