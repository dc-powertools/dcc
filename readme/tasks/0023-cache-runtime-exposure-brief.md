...
`readme/threat-models/0004-dcc-runtime.md` covers state paths pointing at system
...
- Update `readme/threat-models/0004-dcc-runtime.md` with this threat, its control, and
  residual risk.
- Update README and `readme/project/architecture.md` where they describe `/cache` and the
...
- [ ] `readme/threat-models/0004-dcc-runtime.md` records the threat, control, and residual
      risk.
