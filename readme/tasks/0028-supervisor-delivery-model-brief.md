...
`readme/threat-models/0004-dcc-runtime.md` before answering.
...
- If the decision is to keep the `rt` mount: update `readme/tasks/0024-r1-supervisor-design.md`
...
- Upstream artifacts required: `readme/tasks/0024-r1-supervisor-design.md` (D1),
  `readme/tasks/0025-r1-startup-handshake-design.md` (D0, D2),
  `readme/threat-models/0004-dcc-runtime.md`, T-0027's outcome.
...
| The `rt` mount's read-only property is not load-bearing for the threat model | Medium | Q2 explicitly checks this against `readme/threat-models/0004-dcc-runtime.md` |
