...
| Maintain the CLI | Maintainer or agent | Changes Rust code or docs. | Required local checks pass before completion. | Canonical commands live in `.meta/project/standards.md`. |
...
- Required checks: Use the verified command catalog in `.meta/project/standards.md`.
