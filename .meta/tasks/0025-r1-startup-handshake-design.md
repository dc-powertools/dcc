...
`.meta/tasks/0025-supervisor-startup-handshake-brief.md`. Predecessor:
...
> `.meta/decisions/0004-embed-supervisor-in-image.md`. The supervisor *is* now baked into
...
> See `.meta/decisions/0004-embed-supervisor-in-image.md` Q3.
...
| `README.md`, `.meta/project/architecture.md` | Revised startup sequence |
