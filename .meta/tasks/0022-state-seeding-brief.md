...
- Governing decision: `.meta/decisions/0001-state-seeding-from-image.md`
...
- README and `.meta/project/architecture.md` documentation.
...
- Upstream artifacts required: `.meta/decisions/0001-state-seeding-from-image.md`;
