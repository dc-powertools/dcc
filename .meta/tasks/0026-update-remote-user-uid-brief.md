...
- Tests: unit coverage for the no-op conditions and remap argument construction; ignored
  ...
  declared state path.
- Update README and `.meta/project/architecture.md`, including the `remoteUser` /
...
- [ ] README and `.meta/project/architecture.md` document `updateRemoteUserUID` and
