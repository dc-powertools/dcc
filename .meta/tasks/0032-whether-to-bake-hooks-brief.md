...
- If the decision reverses T-0028's provisional conclusion (bake hooks), amend
  `.meta/decisions/0004-embed-supervisor-in-image.md` Q3 and update T-0029's scope to
...
- Upstream artifacts required: `.meta/decisions/0004-embed-supervisor-in-image.md`
